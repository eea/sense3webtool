...
app.controller("mainController", function($scope, $rootScope, $timeout, $http, dataRepository) {
    ...
    $scope.initDefaults = function() {
            ...
            $scope.options.indicators = [{"code":"http://www.eea.europa.eu/data-and-maps/indicators/emissions-of-acidifying-substances-version-2","label":"EEA: Emissions of acidifying substances (CSI 001/APE 007)"},{"code":"http://www.eea.europa.eu/data-and-maps/indicators/designated-areas","label":"EEA: Designated areas (CSI 008)"},{"code":"http://www.eea.europa.eu/data-and-maps/indicators/nutrients-in-freshwater","label":"EEA: Nutrients in freshwater (CSI 020)"},{"code":"http://www.eea.europa.eu/data-and-maps/indicators/greenhouse-gas-emission-trends-5","label":"EEA: Total greenhouse gas (GHG) emission trends and projections (CSI 010/CLIM 050) "},{"code":"http://www.eea.europa.eu/data-and-maps/indicators/municipal-waste-generation","label":"EEA: Municipal waste generation (CSI 016/WST 001)"},{"code":"http://www.eea.europa.eu/data-and-maps/indicators/primary-energy-consumption-by-fuel-3","label":"EEA: Total Gross Inland Consumption by Fuel (CSI 029)"},{"code":"http://www.eea.europa.eu/data-and-maps/indicators/passenger-transport-demand-version-2","label":"EEA: Passenger transport demand (CSI 035/TERM 012)"},{"code":"http://epp.eurostat.ec.europa.eu/cache/ITY_SDDS/EN/org_esms.htm","label":"Eurostat: Organic farming (org)"},{"code":"http://epp.eurostat.ec.europa.eu/cache/ITY_SDDS/EN/tsdpc100_esmsip.htm","label":"Eurostat: Resource productivity (tsdpc100)"},{"code":"http://epp.eurostat.ec.europa.eu/cache/ITY_SDDS/EN/t2020_rl110_esmsip.htm","label":"Eurostat: Domestic material consumption - tonnes per capita (t2020_rl110)"}];
