/**
 * Created by argoaava on 5.05.14.
 */


// Module that provides multiselect box to webform.
//
// Usage Example:
//
// <div multiselect class="multiselect" name="TypeOfUse"multiple="true"
//      ng-model="row.TypeOfUse"
//      options="type.code as type.label for type in codeList.Article17Codelists.TypeOfUses.item"
            ...
            return {
                ...
                link: function (originalScope, element, attrs, modelCtrl) {
                    ...
                    var exp = attrs.options,
                        ...
                        showCheckAll = attrs.showcheckall ? true : false,
                        showFilter = attrs.showfilter ? true : false,
                        required = false,
                    ...
                    function parseModel() {
                        ...
                        for (var i = 0; i < model.length; i++) {
                            ...
                            if (modelCtrl.$modelValue) {
                                if(!(modelCtrl.$modelValue instanceof Array) && model[i].code === modelCtrl.$modelValue) {
                                    checked = true;
                                } else if((modelCtrl.$modelValue instanceof Array) && contains(modelCtrl.$modelValue, model[i].code)) {
                                    checked = true;
                                }
                            }
